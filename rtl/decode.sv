...
module decode (
    ...
    always_comb begin
        unique casez(op)     //ctl_flags = {dst, src,  alu_op}
            8'b0??_010_00:  ctl_flags = {SB_Z, SB_Z, OP_NOP};     // PUS,PUL
            8'b101_010_00:  ctl_flags = {SB_Y, SB_A, OP_NOP};       // TAY
            8'b111_010_00:  ctl_flags = {SB_X, SB_X, OP_INC};       // INX
            8'b110_010_00:  ctl_flags = {SB_Y, SB_Y, OP_INC};       // INY
            8'b100_010_00:  ctl_flags = {SB_Y, SB_Y, OP_DEC};       // DEY
            8'b001_0?1_00:  ctl_flags = {SB_Z, SB_A, OP_AND};       // BIT
            8'b100_110_00:  ctl_flags = {SB_A, SB_Y, OP_NOP};       // TYA
            8'b100_010_10:  ctl_flags = {SB_A, SB_X, OP_NOP};       // TXA
            8'b100_110_10:  ctl_flags = {SB_S, SB_X, OP_NOP};       // TXS
            8'b101_010_10:  ctl_flags = {SB_X, SB_A, OP_NOP};       // TAX
            8'b101_110_10:  ctl_flags = {SB_X, SB_S, OP_NOP};       // TSX
            8'b100_??1_00:  ctl_flags = {SB_DATA, SB_Y, OP_NOP};       // STY
            8'b100_??1_10:  ctl_flags = {SB_DATA, SB_X, OP_NOP};       // STX
            8'b101_000_00,
            8'b101_??1_00:  ctl_flags = {SB_Y, SB_DATA, OP_NOP};       // LDY
            8'b101_??1_10,
            8'b101_000_10:  ctl_flags = {SB_X, SB_DATA, OP_NOP};       // LDX
            8'b100_???_?1:  ctl_flags = {SB_DATA, SB_A, OP_NOP};       // STA
            8'b101_???_?1:  ctl_flags = {SB_A, SB_DATA, OP_NOP};       // LDA
            8'b110_011_00,
            8'b110_00?_00:  ctl_flags = {SB_Z, SB_Y, OP_CMP};       // CPY
            8'b111_011_00,
            8'b111_00?_00:  ctl_flags = {SB_Z, SB_X, OP_CMP};       // CPX
            8'b110_???_?1:  ctl_flags = {SB_Z, SB_A, OP_CMP};       // CMP
            8'b000_???_?1:  ctl_flags = {SB_A, SB_A, OP_ORA};       // ORA
            8'b001_???_?1:  ctl_flags = {SB_A, SB_A, OP_AND};       // AND
            8'b010_???_?1:  ctl_flags = {SB_A, SB_A, OP_XOR};       // EOR
            8'b011_???_?1:  ctl_flags = {SB_A, SB_A, OP_ADC};       // ADC
            8'b111_???_?1:  ctl_flags = {SB_A, SB_A, OP_SBC};       // SBC
            8'b000_010_10:  ctl_flags = {SB_A, SB_A, OP_ASL};       // ASL, A
            8'b001_010_10:  ctl_flags = {SB_A, SB_A, OP_ROL};       // ROL, A
            8'b010_010_10:  ctl_flags = {SB_A, SB_A, OP_LSR};       // LSR, A  
            8'b011_010_10:  ctl_flags = {SB_A, SB_A, OP_ROR};       // ROR, A  
            8'b110_??0_10:  ctl_flags = {SB_X, SB_X, OP_DEC};       // DEX
            8'b110_??1_10:  ctl_flags = {SB_DATA, SB_DATA, OP_DEC};       // DEC rmw
            8'b111_??1_10:  ctl_flags = {SB_DATA, SB_DATA, OP_INC};       // INC rmw
            8'b000_??1_10:  ctl_flags = {SB_DATA, SB_DATA, OP_ASL};       // ASL rmw
            8'b001_??1_10:  ctl_flags = {SB_DATA, SB_DATA, OP_ROL};       // ROL rmw
            8'b010_??1_10:  ctl_flags = {SB_DATA, SB_DATA, OP_LSR};       // LSR rmw
            8'b011_??1_10:  ctl_flags = {SB_DATA, SB_DATA, OP_ROR};       // ROR rmw
            default:        ctl_flags = {SB_Z, SB_Z, OP_NOP};       // ctrl flow, set/clear, NOP
        endcase
    end
